...
/**
 * REST controller for managing {@link com.sprintly.domain.Map}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class MapResource {
     ...
     */
    @PutMapping("/maps/{id}")
    public ResponseEntity<Map> updateMap(@PathVariable(value = "id", required = false) final Long id, @RequestBody Map map)
    ...
    public ResponseEntity<Map> partialUpdateMap(@PathVariable(value = "id", required = false) final Long id, @RequestBody Map map)
        throws URISyntaxException {
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, map.getId().toString())
        );
    }
