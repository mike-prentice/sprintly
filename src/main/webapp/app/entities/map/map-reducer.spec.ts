...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './map.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MAP_LIST actions', async () => {
    ...
    it('dispatches FETCH_MAP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MAP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MAP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MAP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MAP actions', async () => {
      const expectedActions = [
        {
