...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './stats.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STATS_LIST actions', async () => {
    ...
    it('dispatches FETCH_STATS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_STATS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_STATS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_STATS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_STATS actions', async () => {
      const expectedActions = [
        {
