...
export const Ranking = (props: RouteComponentProps<{ url: string }>) => {
    ...
    <div>
      ...
      <div className="table-responsive">
        {rankingList && rankingList.length > 0 ? (
                ...
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button tag={Link} to={`/ranking/${ranking.id}/delete`} color="danger" size="sm" data-cy="entityDeleteButton">
          ...
          !loading && <div className="alert alert-warning">No Rankings found</div>
        )}
      </div>
    </div>
  );
