...
import { getEntity, deleteEntity } from './ranking.reducer';

export const RankingDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="sprintlyApp.ranking.delete.question">Are you sure you want to delete this Ranking?</ModalBody>
      <ModalFooter>
