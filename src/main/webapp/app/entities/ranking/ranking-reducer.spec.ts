...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './ranking.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RANKING_LIST actions', async () => {
    ...
    it('dispatches FETCH_RANKING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RANKING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RANKING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RANKING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RANKING actions', async () => {
      const expectedActions = [
        {
