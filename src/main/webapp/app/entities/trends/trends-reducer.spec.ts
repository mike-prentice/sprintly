...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './trends.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRENDS_LIST actions', async () => {
    ...
    it('dispatches FETCH_TRENDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TRENDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TRENDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TRENDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TRENDS actions', async () => {
      const expectedActions = [
        {
