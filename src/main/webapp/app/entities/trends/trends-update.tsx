...
import { getEntity, updateEntity, createEntity, reset } from './trends.reducer';

export const TrendsUpdate = (props: RouteComponentProps<{ id: string }>) => {
  ...
  const updating = useAppSelector(state => state.trends.updating);
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="sprintlyApp.trends.home.createOrEditLabel" data-cy="TrendsCreateUpdateHeading">
            Create or edit a Trends
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <Button tag={Link} id="cancel-save" data-cy="entityCreateCancelButton" to="/trends" replace color="info">
